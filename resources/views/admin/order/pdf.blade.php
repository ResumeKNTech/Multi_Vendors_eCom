...
<style type="text/css">
  ...
  <div class="invoice-description">
    ...
    <div class="invoice-right-top float-right" class="text-right">
      ...
      {{-- <img class="img-responsive" src="data:image/png;base64, {{ base64_encode(QrCode::format('png')->size(150)->generate(route('admin.product.admin.order.show', $order->id )))}}"> --}}
    </div>
    <div class="clearfix"></div>
  </div>
  <section class="order_details pt-3">
    ...
    <table class="table table-bordered table-stripe">
      ...
      @php
        $product=DB::table('products')->select('product_title')->where('id',$cart->product_id)->get();
      @endphp
        <tr>
          <td><span>
