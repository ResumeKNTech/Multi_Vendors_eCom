            ...
            <div class="d-sm-flex align-items-top p-4 border-bottom-0 main-profile-cover">
                ...
                <div class="flex-fill main-profile-info">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{route("admin.vendor.edit", $user->id) }}" class="btn btn-light btn-wave"><i class="ri-add-line me-1 align-middle d-inline-block"></i>Đổi thông tin</a>
                    </div>
            ...
            <div class="p-4 border-bottom border-block-end-dashed">
                ...
                <div class="mb-0">
                    ...
                    <div class="mb-0">
                        ...
                        <p class="mb-0">
                            <a href="https://themeforest.net/user/spruko/portfolio" class="text-primary"><u>{{ $user->link_zalo }}</u></a>
                        </p>
                        <p class="mb-0">
                            <a href="https://themeforest.net/user/spruko/portfolio" class="text-primary"><u>{{ $user->link_github }}</u></a>
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div>
                            <ul class="nav nav-tabs mb-0 tab-style-6 justify-content-start" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="activity-tab" data-bs-toggle="tab" data-bs-target="#activity-tab-pane" type="button" role="tab" aria-controls="activity-tab-pane" aria-selected="true"><i class="ri-gift-line me-1 align-middle d-inline-block"></i>Tất Cả Danh
                                        Mục</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="posts-tab" data-bs-toggle="tab" data-bs-target="#posts-tab-pane" type="button" role="tab" aria-controls="posts-tab-pane" aria-selected="false"><i class="ri-bill-line me-1 align-middle d-inline-block"></i>Tất Cả Sản
                                        Phẩm</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="followers-tab" data-bs-toggle="tab" data-bs-target="#followers-tab-pane" type="button" role="tab" aria-controls="followers-tab-pane" aria-selected="false"><i class="ri-money-dollar-box-line me-1 align-middle d-inline-block"></i>Doanh
                                        Thu</button>
                                </li>
                                    ...
                                    <li>
                                        <div>
                                            ...
                                            <p class="mb-1">
                                                ...
                                                <b>{{ $data->category_name }}</b>.<span class="float-end fs-11 text-muted">{{ $data->category_created_at }}</span>
                                            </p>
                                            @php
                                                    ...
                                                    <div class="p-3 d-flex align-items-top flex-wrap">
                                                        ...
                                                        <div class="flex-fill">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between mb-md-0 mb-2">
                                                                <div>
                                                                    <div class="btn-list">
                                                                        <button class="btn btn-primary-light btn-sm btn-wave" disabled>
                                                                            Giá: {{ $product->price }}
                                                                        </button>
                                                        ...
                                                        <div>
                                                            <div class="d-flex align-items-top">
                                                                <div>
                                                                    <span class="badge bg-success-transparent me-2">{{ $product->brand_name }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="avatar-list-stacked d-block mt-4 ">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="{{ asset($product->logo_images) }}" alt="img">
                                                                </span>
                            ...
                            <a href="javascript:void(0);">
                                <div class="d-flex flex-wrap align-items-center">
                                    <span class="avatar avatar-md me-3">
                                        <img src="{{ asset($product->images) }}" class="img-fluid" alt="...">
                                    </span>
                                    <div class="flex-fill">
