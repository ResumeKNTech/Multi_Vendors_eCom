                    ...
                    <tr>
                        ...
                        <td>
                            <div class="hstack gap-2 fs-15">
                                <button class="btn btn-icon btn-s, btn-info editBtn" data-id="{{ $relationship->id }}"
                                    data-user-id="{{ $relationship->user_id }}"
                                    data-category-id="{{ $relationship->category_id }}"
                                    data-brand-id="{{ $relationship->brand_id }}"><i class="ri-edit-line"></i></button>
                                <button class="btn btn-icon btn-sm btn-danger" onclick="confirmDelete('{{ route('admin.user_relationship.destroy', $relationship->id) }}')"><i class="ri-delete-bin-6-line"></i></button>
                            </div>
                        </td>
                    </tr>
                    @endforeach
