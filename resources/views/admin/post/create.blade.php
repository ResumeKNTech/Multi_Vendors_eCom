    ...
    <div class="card custom-card">
                                ...
                                <div class="card-body p-0">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <input type="text" class="form-control" id="product_title" name="title" placeholder="Tiêu đề sản phẩm...">
                                            <label for="product-name-add" class="form-label mt-1 fs-12 op-5 text-muted mb-0">*Tiêu đề sản phẩm
                                                không
                                                nên
                                                quá 30 kí tự</label>
                                        </div>
                                        ...
                                        <div class="col-xl-12">
                                            <label for="post_cat_id" class="form-label">Danh Mục:</label>
                                            <select class="form-control" data-trigger name="post_cat_id" id="post_cat_id">
                            ...
                            <div class="card-body p-0">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card custom-card">
                                            ...
                                            <div class="card-body dropzone" ondragover="allowDrop(event)" ondrop="drop(event)" onclick="triggerInputFile()">
                                                <input type="file" class="single-fileupload" name="photo" accept="image/png, image/jpeg, image/gif" style="display: none;" onchange="handleFileChange(this)">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <select class="form-control" data-trigger name="status" id="product-status-add1">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" multiple class="form-control" name="tags[]" id="product-tags" placeholder="Nhập thẻ tags">
                                    </div>
        ...
        <div class="px-4 py-3 border-top border-block-start-dashed d-sm-flex justify-content-end">
            <div class="form-group mb-3">
                ...
                <button type="submit" class="btn btn-primary-light m-1">Thêm Sản Phẩm<i class="bi bi-plus-lg ms-2"></i></button>
            </div>
