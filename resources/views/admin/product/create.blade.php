                                        ...
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <input type="text" class="form-control" id="product_title"
                                                    name="product_title" placeholder="Tiêu đề sản phẩm...">
                                                <label for="product-name-add"
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <select class="form-control" data-trigger name="brand_id" id="brand_id">
                                                    ...
                                                    @foreach ($brands as $i)
                                                        <option value="{{ $i->id }}">{{ $i->brand_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <textarea class="form-control" id="product-description-add" name="short_description" rows="2"></textarea>
