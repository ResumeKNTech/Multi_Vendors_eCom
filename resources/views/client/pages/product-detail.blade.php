...
@section('meta')
    ...
    <meta property="og:description" content="{{ $product_detail->product_description }}">
@endsection
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="product-gallery">
                                ...
                                <div class="flexslider-thumbnails">
                                    <ul class="slides">
                                        @php
                                            $photo = explode(',', $product_detail->images_gallery);
                                            // dd($photo);
                                        @endphp
                                                            ...
                                                            <div class="single-rating">
                                                                <div class="rating-author">
                                                                    @if ($data->user_info['user_image'])
                                                                        <img src="{{ asset($data->user_info['user_image']) }}"
                                                                            alt="{{ $data->user_info['user_image'] }}">
                                                                    @else
                                ...
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="{{ route('product-detail', $data->slug) }}">
                                            ...
                                            <img class="hover-img" src="{{ asset($photo[0]) }}"
                                                alt="{{ $photo[0] }}">
                                            @php
                                                $discountPercentage = (($data->price - $data->offer_price) / $data->price) * 100;
                                            @endphp

                                            <span class="price-dec">{{ round($discountPercentage, 2) }}% Off</span>
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            <span class="old">{{ $data->price }} VND</span>
                                            <span>{{ $data->offer_price }} VND</span>
                                        </div>
