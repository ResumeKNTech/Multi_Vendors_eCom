...
@section('meta')
	...
	<meta name="description" content="{{$product_detail->short_des}}">
	<meta property="og:url" content="{{route('product-detail',$product_detail->slug)}}">
	<meta property="og:type" content="article">
	<meta property="og:title" content="{{$product_detail->product_title}}">
	<meta property="og:image" content="{{$product_detail->images}}">
									...
									<div class="col-lg-6 col-12">
										...
										<div class="product-gallery">
											...
											<div class="flexslider-thumbnails">
												<ul class="slides">
													@php 
														$photo=explode(',',$product_detail->images);
													// dd($photo);
													@endphp
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
												...
												<p class="price"><span class="discount">${{number_format($offer_price)}}</span><s>${{number_format($product_detail->price,2)}}</s> </p>
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	You need to <a href="{{route('auth.login')}}" style="color:rgb(54, 54, 204)">Login</a> OR <a style="color:blue" href="{{route('auth.register')}}">Register</a>
																...
																<div class="ratting-main">
																	...
																	<div class="single-rating">
																		<div class="rating-author">
																			@if($data->user_info['user_image'])
																			<img src="{{$data->user_info['user_image']}}" alt="{{$data->user_info['user_image']}}">
																			@else 
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            <span>${{number_format($data->offer_price)}}</span>
                                        </div>
