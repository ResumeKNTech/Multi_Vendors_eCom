                    ...
                    <div class="blog-single-main">
                        <div class="row">
                            ...
                            <p class="text-center p-5">
                                You need to <a href="{{route('client.login')}}" style="color:rgb(54, 54, 204)">Login</a> OR <a style="color:blue" href="{{route('client.register')}}">Register</a> for comment.
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    ...
                                    <!-- Single Comment -->
                                    @include('client.pages.comment', ['comments' => $post->comments, 'post_id' => $post->id, 'depth' => 3])
                                    <!-- End Single Comment -->
                                </div>
                            </div>
                        </div>
