            ...
            <div class="carousel-inner" role="listbox">
                @foreach ($banners as $key => $banner)
                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                        <img class="first-slide" src="{{ $banner->photo }}"  style="padding: 10% 10%" alt="First slide">
                ...
                <div class="col-12">
                    <div class="product-info">
                        ...
                        <div class="tab-content isotope-grid" id="myTabContent">
                            <!-- Start Single Tab -->
                            @php
                                $product_lists = DB::table('products')->get(); // Adjust the limit as needed
                            @endphp
                            @if ($product_lists)
                                    ...
                                    <div
                                        ...
                                        <div class="single-product">
                                            <div class="product-img">
                                                <a href="{{ route('client.index', $product->slug) }}">
                                                    @php
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        ...
                                                        <a title="Wishlist"
                                                            href="{{ route('client.index', $product->slug) }}"><i
                                                                class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                                    </div>
                                                    <div class="product-action-2">
                                                        <a title="Add to cart"
                                                            href="{{ route('client.index', $product->slug) }}">Add to
                                                            cart</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="product-content">
                                                <h3><a
                                                        href="{{ route('client.index', $product->slug) }}">{{ $product->product_title }}</a>
                                                </h3>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="list-image overlay">
                                                ...
                                                <a href="{{ route('client.index', $product->slug) }}" class="buy"><i
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12 no-padding">
                                            <div class="content">
                                                ...
                                                <p class="price with-discount">{{ $product->offer_price }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @foreach ($vendors as $vendors)
                        <div class="col-lg-4 col-md-6 col-12">
                            ...
                            <div class="shop-single-blog">
                                <img src="{{ asset($vendors->user_image) }}" alt="{{ $vendors->user_image }}">
                                <div class="content">
                                    @foreach ($vendors->relatedCategories as $category)
                                    {{ $category->category_name }}
                                    @endforeach
                                    <a
                                        href="
                                        class="title">{{ $vendors->name }}</a>
                                    <a href="" class="more-btn">Go to shop ?</a>
                                </div>
                            </div>
                            <!-- End Single Blog  -->
                        </div>
